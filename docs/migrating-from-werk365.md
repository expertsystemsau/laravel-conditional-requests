...
- **You are on PHP below 8.3 or Laravel below 12.** The incumbent requires `illuminate/support: ~7|~8|~9|~10|~11|~12` and declares no `php` constraint at all; this package requires `php: ^8.3` and `^12.0||^13.0`. There is no backport.
